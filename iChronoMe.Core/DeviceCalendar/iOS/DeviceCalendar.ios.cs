...
namespace iChronoMe.DeviceCalendar
{
    ...
    public static partial class DeviceCalendar
    {
        ...
        private static async Task RequestCalendarAccess()
        {
        ...
        private static EKCalendar SaveEKCalendar(IEnumerable<EKSource> sources, string calendarName,
        ...
        /// <param name="color">Calendar color.</param>
        /// <exception cref="System.InvalidOperationException">No active calendar sources available to create calendar on.</exception>
        private static EKCalendar CreateEKCalendar(string calendarName, string color = null)
        {
