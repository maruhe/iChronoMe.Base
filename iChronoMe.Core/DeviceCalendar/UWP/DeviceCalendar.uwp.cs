...
namespace iChronoMe.DeviceCalendar
{
    ...
    public static partial class DeviceCalendar
    {
        ...
        private static AppointmentStore _apptStore;
        private static AppointmentStore _localApptStore;
        ...
        /// <exception cref="System.UnauthorizedAccessException">Calendar access denied</exception>
        /// <exception cref="Plugin.Calendars.Abstractions.PlatformException">Unexpected platform-specific error</exception>
        public static async Task<Calendar> GetCalendarByIdAsync(string externalId)
        {
        ...
        /// <exception cref="System.UnauthorizedAccessException">Calendar access denied</exception>
        /// <exception cref="Plugin.Calendars.Abstractions.PlatformException">Unexpected platform-specific error</exception>
        public static async Task<CalendarEvent> GetEventByIdAsync(string externalId)
        {
            if (string.IsNullOrWhiteSpace(externalId))
            {
                return null;
        ...
        private static async Task<AppointmentCalendar> CreateAppCalendarAsync(string calendarName)
        {
            await EnsureInitializedAsync().ConfigureAwait(false);
        ...
        private static async Task<AppointmentCalendar> GetAndValidateLocalCalendarAsync(string id)
        {
            AppointmentCalendar appCalendar = null;
        ...
        private static async Task<AppointmentCalendar> GetLocalCalendarAsync(string id)
        {
#if WINDOWS_UWP
